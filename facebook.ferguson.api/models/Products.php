...
class Products {
	...
	public static function set() {
		// Modern
		self::add('modern', 'lights', 'high', 'Hudson Valley Lighting "Southport" Light', 'The "Southport" light by Hudson Valley presents a top-line and streamlined solution to illuminating your bathroom.');
